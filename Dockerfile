...
ENV FLUENTD_PLUGINS_TO_INSTALL fluent-plugin-concat fluent-plugin-multiline-parser fluent-plugin-webhdfs fluent-plugin-s3 fluent-plugin-azurestorage fluent-plugin-gcs fluent-plugin-cloudwatch-logs fluent-plugin-multi-format-parser fluent-plugin-detect-exceptions
